...
import com.metmit.simulation.handler.xpath.parser.expression.token.consumer.AttributeActionConsumer;
import com.metmit.simulation.handler.xpath.parser.expression.token.consumer.BooleanConsumer;
import com.metmit.simulation.handler.xpath.parser.expression.token.consumer.DefaultWordConsumer;
import com.metmit.simulation.handler.xpath.parser.expression.token.consumer.DefaultXpathConsumer;
import com.metmit.simulation.handler.xpath.parser.expression.token.consumer.DigitConsumer;
import com.metmit.simulation.handler.xpath.parser.expression.token.consumer.ExpressionConsumer;
import com.metmit.simulation.handler.xpath.parser.expression.token.consumer.FunctionConsumer;
import com.metmit.simulation.handler.xpath.parser.expression.token.consumer.OperatorConsumer;
import com.metmit.simulation.handler.xpath.parser.expression.token.consumer.StringConstantConsumer;
import com.metmit.simulation.handler.xpath.parser.expression.token.consumer.XpathConsumer;
import com.metmit.simulation.handler.xpath.parser.expression.token.handler.AttributeHandler;
import com.metmit.simulation.handler.xpath.parser.expression.token.handler.BooleanHandler;
import com.metmit.simulation.handler.xpath.parser.expression.token.handler.ConstantHandler;
import com.metmit.simulation.handler.xpath.parser.expression.token.handler.ExpressionHandler;
import com.metmit.simulation.handler.xpath.parser.expression.token.handler.FunctionHandler;
import com.metmit.simulation.handler.xpath.parser.expression.token.handler.NumberHandler;
import com.metmit.simulation.handler.xpath.parser.expression.token.handler.XpathHandler;
