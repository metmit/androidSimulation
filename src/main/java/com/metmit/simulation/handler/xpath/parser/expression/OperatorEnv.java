...
import com.metmit.simulation.handler.xpath.parser.expression.operator.AddUnit;
import com.metmit.simulation.handler.xpath.parser.expression.operator.And2Unit;
import com.metmit.simulation.handler.xpath.parser.expression.operator.AndUnit;
import com.metmit.simulation.handler.xpath.parser.expression.operator.ContainUnit;
import com.metmit.simulation.handler.xpath.parser.expression.operator.DivideUnit;
import com.metmit.simulation.handler.xpath.parser.expression.operator.EndWithUnit;
import com.metmit.simulation.handler.xpath.parser.expression.operator.EqualUnit;
import com.metmit.simulation.handler.xpath.parser.expression.operator.GreaterEqualUnit;
import com.metmit.simulation.handler.xpath.parser.expression.operator.GreaterThanUnit;
import com.metmit.simulation.handler.xpath.parser.expression.operator.LessEqualUnit;
import com.metmit.simulation.handler.xpath.parser.expression.operator.LessThanUnit;
import com.metmit.simulation.handler.xpath.parser.expression.operator.MinusUnit;
import com.metmit.simulation.handler.xpath.parser.expression.operator.MultiUnit;
import com.metmit.simulation.handler.xpath.parser.expression.operator.NotEqualUnit;
import com.metmit.simulation.handler.xpath.parser.expression.operator.NotMatchUnit;
import com.metmit.simulation.handler.xpath.parser.expression.operator.OpKey;
import com.metmit.simulation.handler.xpath.parser.expression.operator.Or2Unit;
import com.metmit.simulation.handler.xpath.parser.expression.operator.OrUnit;
import com.metmit.simulation.handler.xpath.parser.expression.operator.RegexUnit;
import com.metmit.simulation.handler.xpath.parser.expression.operator.RemainderUnit;
import com.metmit.simulation.handler.xpath.parser.expression.operator.StartWithUnit;
...
public class OperatorEnv {
    ...
    public static synchronized List<AlgorithmHolder> allAlgorithmUnitList() {
        return ListUtils.newCopyOnWriteArrayList(allOperators);
    }
